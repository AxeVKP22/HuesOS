...
ld -m elf_i386 -T linker.ld build/kernel.o build/fs.o build/keyboard.o build/vga.o build/vgac.o build/power.o build/disk.o build/mem.o build/string.o build/con.o build/ddump.o -o build/kernel.bin -Map=build/kernel.map
